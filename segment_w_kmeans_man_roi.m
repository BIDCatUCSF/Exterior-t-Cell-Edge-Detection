function[bound_ret_sort,image_adam_save,button_ret]=segment_w_kmeans_man_roi(im_now1,button_in,x_c,y_c)
...
mean_dist_ken=mean(bound_ret_sort2(:,4));
std_dist_ken=std(bound_ret_sort2(:,4));

%sorting this matrix
bound_ret_sort2_sort=sortrows(bound_ret_sort2,4);
